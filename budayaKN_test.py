...
def main():
    ...
    #### Test cari
            elif command[0].upper() == "CARINAMA":

                keyCari = ' '.join(command[1:])
    ...
    # print(mydb)
                ...
                keyCari = ' '.join(command[1:]).split(",")
                # result = mydb.tambah("Piring", "Tarian", "Sumatera Barat", "http://something")
                result = mydb.tambah(*keyCari)
                if result == 1:
    ...
    #### Test stat
                ...
                print(mydb.stat())
            elif command[0].upper() == "STATTIPE":
                print(mydb.statByTipe())
            elif command[0].upper() == "STATPROV":
                print(mydb.statByProv())

    #### Test export
            elif command[0].upper() == "EKSPOR":
